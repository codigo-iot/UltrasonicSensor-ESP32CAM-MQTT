 ...
 * 
 * Este programa lee el sensor ultrasonico con la bilbioteca Ultrasonic de Erick Simoes
 * en su version 3.0.0. Se mezcla con el programa ESP32CAM-MQTT-basic del repositorio de
 * Codigo-iot.
 * 
...
PubSubClient client(espClient); // Este objeto maneja los datos de conexional broker
Ultrasonic ultrasonic(pinTrigger, pinEcho); //Obijeto que maneja el sensor
